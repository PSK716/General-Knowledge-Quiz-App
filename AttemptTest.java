...
import com.example.quizzy.Results_section.Main3Activity;
...
//import com.example.quizzy.MainActivity2;
...
public class AttemptTest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        description=new String[questions.size()];
        ...
        result=findViewById(R.id.textView15);
...
//&&description[i].equals(questions.get(i).getDescription())


            list.add(" Your choice : ("+
                    temp  +
                    "\n Right choice : ("+ questions.get(i).getAnswer()+")"+"\n Explanation:\n"+ questions.get(i).getDescription());
        ...
        try
        {
            ...
            Log.e("Score1", textView16.getText().toString());
//            result.setText(score+" /10");
//            result.setText("Score"+);

            //result1=result.getText().toString();
        }
        catch (Exception e)
        {
    ...
    void dialogStart() {
        ...
        builderSingle.setNegativeButton("Done!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                finish();
                dialog.dismiss();
                Intent i1=new Intent(AttemptTest.this, Main3Activity.class);
                String sco=textView16.getText().toString();
                i1=i1.putExtra("Scoore", sco);
                Log.e("score3","yes");
                startActivity(i1);
